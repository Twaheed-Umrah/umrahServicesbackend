    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('superadmin', 'SuperAdmin'), ('agencyadmin', 'AgencyAdmin'), ('franchisesadmin', 'FranchisesAdmin'), ('freelancer', 'Freelancer')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('verification_type', models.CharField(choices=[('email', 'Email Verification'), ('phone', 'Phone Verification')], max_length=10)),
                ('otp', models.CharField(max_length=6)),
                ('new_value', models.CharField(help_text='New email or phone number to be verified', max_length=255)),
